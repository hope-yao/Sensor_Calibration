...
net = {}
k = 2
net['enc1'] = slim.fully_connected(input_pl, 1024*k, scope='enc/fc1')
net['enc2'] = slim.fully_connected(net['enc1'], 1024*k, scope='enc/fc2')
net['enc3'] = slim.fully_connected(net['enc2'], 512*k, scope='enc/fc3')
net['enc4'] = slim.fully_connected(net['enc3'], 512*k, scope='enc/fc4')
net['enc5'] = slim.fully_connected(net['enc4'], 256*k, scope='enc/fc5')
net['enc6'] = slim.fully_connected(net['enc5'], 256*k, scope='enc/fc6')
net['enc7'] = slim.fully_connected(net['enc6'], 256, scope='enc/fc7')
net['enc8'] = slim.fully_connected(net['enc7'], 256, scope='enc/fc8')
net['dec1'] = slim.fully_connected(net['enc8'], 512*k, scope='dec/fc1')
net['dec2'] = slim.fully_connected(net['dec1'], 512*k, scope='dec/fc2')
net['dec3'] = slim.fully_connected(net['dec2'], 1024*k, scope='dec/fc3')
net['dec4'] = slim.fully_connected(net['dec3'], 1024*k, scope='dec/fc4')
